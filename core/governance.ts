 ...
 */
export async function makeImmutable(memoryId: string, reason: string): Promise<void> {
  if (!config.governanceEnabled) return;
 ...
 */
export async function canModifyMemory(memoryId: string, actorId: string): Promise<boolean> {
  if (!config.governanceEnabled) return true;
 ...
 */
export async function canReadMemory(memoryId: string, actorId: string): Promise<boolean> {
  if (!config.governanceEnabled) return true;
 ...
 */
export async function setWriteScope(memoryId: string, scope: string[]): Promise<void> {
  if (!config.governanceEnabled) return;
 ...
 */
export async function setReadScope(memoryId: string, scope: string[]): Promise<void> {
  if (!config.governanceEnabled) return;
