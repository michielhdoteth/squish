...
export type MemoryKnowledgeType = 'observation' | 'fact' | 'decision' | 'context' | 'preference' | 'note' | 'task';
/** Belief subtypes (from core/beliefs/types.ts BeliefType) */
export type BeliefKnowledgeType = 'decision' | 'preference' | 'failure_cause' | 'constraint' | 'state_change' | 'dispute';
/** Strategy subtypes */
export type StrategyKnowledgeType = 'procedure' | 'heuristic' | 'pattern' | 'constraint' | 'workaround';
/** All knowledge types combined */
export type KnowledgeType = MemoryKnowledgeType | BeliefKnowledgeType | StrategyKnowledgeType;
/** Entity types from the graph system (extensible) */
export type EntityType = 'file' | 'function' | 'class' | 'module' | 'variable' | 'concept' | 'person' | 'project' | 'tool' | 'api' | 'bug' | 'feature' | 'requirement' | 'decision' | 'event' | string;
/** Place types from the spatial system (extensible) */
export type PlaceType = 'inbox' | 'reference' | 'workspace' | 'sandbox' | 'board' | 'sparks' | 'archive' | string;
/** Unified status across all knowledge kinds */
export type KnowledgeStatus = 'active' | 'superseded' | 'deprecated' | 'experimental' | 'disputed';
...
export type KnowledgeEdgeType = 'contradicts' | 'supersedes' | 'supports' | 'informed_by' | 'depends_on' | 'extends' | 'related_to' | 'causes' | 'rejects' | 'sourced_from' | 'references' | 'about' | 'describes' | 'created_by' | 'affects' | 'located_in' | 'belongs_to' | 'context_of' | 'works_on' | 'manages' | 'uses' | 'contains' | 'implements' | 'part_of' | 'owns' | 'resolved' | 'blocks' | 'operates_in';
